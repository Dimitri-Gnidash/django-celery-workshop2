# Django settings for django_celery_workshop project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mydb.sql',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '_34vcsz6bp_g%&amp;(j#ecqo!osp+muely5=z_f=m=d7ctj!!yvt$'
...
TEMPLATE_DIRS = (
    "/Users/dimitri/projects/workshop2/workshop2/templates/",
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
)
